...
createImage('img/img-1.jpg')
  .then(img => {
    currentImage = img; // asignamos currentImage
    console.log('Image 1 loaded'); // Escribimos por consola
    return wait(2); // Esperamos por 2 segundos
  })
  .then(() => {
    currentImage.style.display = 'none'; // Escondemos la currentImage
    createImage('img/img-2.jpg') // Volvemos a llamar para la siguiente
      .then(img => {
        currentImage = img; // Asignamos currentImage
        console.log('Image 2 loaded'); // Escribimos por consola
        return wait(2); // Esperamos por 2 segundos
      })
      .then(() => {
        currentImage.style.display = 'none'; // Escondemos la currentImage
