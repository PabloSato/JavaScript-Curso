...
class App {
  ...
  _loadMap(position) {
    ...
    this.#map = L.map('map').setView(coords, this.#mapZoomLevel); // hay que pasar el array con las coordenadas (primero latitud) y el otro parámetro es el valor del zoom
  ...
  _newWorkout(e) {
    //Funcion de validación de inputs
    ...
    // 4 - Añadimos el nuevo objeto al workout array
