...
class App {
  ...
  _getLocalStorage() {
    ...
    this.#workouts.forEach(work => {
      ...
      // this._renderWorkoutMarker(work);// => no podemos poner esto aqui, porq en este momento aun no se ha podido cargar el mapa, nos lo llevamos a la función de loadMap
    });
  }
